...
waffle.pngs(from="2017-06-01", to="2023-06-01", width=100, height=57, delay = 0.3, pause=8, keeppng = TRUE)
```
...
```{r}
waffle.pngs(lecode="code du travail",from="2017-06-01", to="2023-06-01", width=120, height=120, delay = 0.3, pause=8, keeppng = FALSE)
```