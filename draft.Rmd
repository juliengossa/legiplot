...
waffle.pngs(from="2017-06-01", to="2023-06-01", width=100, height=57, delay = 0.3, pause=8, keeppng = FALSE)
```
...
waffle.scol(width=100, height=60, delay = 0.3, pause=8, keeppng = FALSE)
```