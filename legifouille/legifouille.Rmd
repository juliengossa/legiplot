...
lfversions %>% 
  summarise(versions = n_distinct(debut), .by = c(partie,président)) %>%
...
lfliensmod <- lfliens %>%
  ...
  summarise(n_modifs = n_distinct(NUM, na.rm = TRUE), .by = c(lien_numtexte,lien_naturetexte,lien_datesignatexte)) %>%
